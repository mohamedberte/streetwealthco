...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-border/70 bg-white/76 backdrop-blur-xl">
      <div className="border-b border-border/50 px-4 py-2 text-center text-[9px] uppercase tracking-[0.26em] text-muted sm:px-6 sm:text-[10px] sm:tracking-[0.28em]">
      ...
      <div className="mx-auto max-w-[78rem] px-4 py-4 sm:px-6">
        <div className="grid items-center gap-3 md:grid-cols-[1fr_auto_1fr] md:gap-4">
          ...
          <div className="flex w-full items-center justify-center gap-5 text-[10px] uppercase tracking-[0.2em] sm:gap-6 sm:text-[11px] sm:tracking-[0.24em] md:w-auto md:justify-end">
            <Link
              href="/boutique"
              className="border-b border-transparent text-brand transition-colors hover:border-brand/60 hover:text-brown"
            >
              Boutique privée
            </Link>
            <CartButton />
