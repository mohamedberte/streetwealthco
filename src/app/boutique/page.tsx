  ...
  return (
    <div className="overflow-x-clip">
      <section data-parallax-root className="relative isolate min-h-[64svh] overflow-hidden border-b border-border/70">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(158deg,rgba(22,18,15,0.28)_6%,rgba(22,18,15,0.74)_86%)]" />
        ...
        <div className="relative mx-auto flex min-h-[64svh] max-w-[86rem] items-end px-4 pb-12 pt-20 sm:px-6 sm:pb-16">
          <div data-reveal className="max-w-3xl">
            ...
            <h1 className="mt-4 font-serif text-4xl text-ivory sm:text-6xl">
          ...
          {products.map((product, index) => (
            ...
            >
              <Link
                ...
                className="group relative isolate block min-h-[28rem] overflow-hidden rounded-[1.2rem] border border-border/70"
              >
                <Image
                ...
                />
                <div className="absolute inset-0 bg-[linear-gradient(178deg,rgba(22,18,15,0.14)_8%,rgba(22,18,15,0.82)_88%)]" />

                <div className="relative z-10 flex h-full flex-col justify-end p-6 sm:p-7">
                  <p className="text-[11px] uppercase tracking-[0.2em] text-ivory/78">
                    {product.silhouette}
                  </p>
                  <h2 className="mt-4 font-serif text-2xl text-ivory">{product.name}</h2>
                  <p className="mt-2 text-sm text-ivory/84">{formatPrice(product.price)}</p>
                </div>
              </Link>
            </li>
          ))}
